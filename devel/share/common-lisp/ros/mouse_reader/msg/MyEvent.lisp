...
(cl:defmethod cl:initialize-instance :after ((m <MyEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mouse_reader-msg:<MyEvent> is deprecated: use mouse_reader-msg:MyEvent instead.")))
